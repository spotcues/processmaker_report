...
class DynaForm
{
    ...
    /**
     * Get data of a DynaForm, custom function
     *
     * @param string $dynaFormUid Unique id of DynaForm
     *
     * return array Return an array with data of a DynaForm
     */
    public function getDynaFormCustom($dynaFormUid)
    {
        try {
            //Verify data
            $this->throwExceptionIfNotExistsDynaForm($dynaFormUid, "", $this->arrayFieldNameForException["dynaFormUid"]);
     ...
     * return array Return an array with data of a DynaForm
     */
    public function getDynaFormsCustom($proUid, $dynaFormUid)
    {
        try {
            //Verify data
            $this->throwExceptionIfNotExistsDynaForm($dynaFormUid, "", $this->arrayFieldNameForException["dynaFormUid"]);
            ...
            $criteria->add(\DynaformPeer::DYN_UID, $dynaFormUid, \Criteria::NOT_EQUAL);
