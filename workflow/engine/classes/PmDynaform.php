...
use ProcessMaker\BusinessModel\Dynaform as CustomDynaform;
...
class PmDynaform
{
    ...
    public function __construct($fields = [])
    {
        ...
        // $this->getDynaform();
        // $this->getDynaforms();
        $this->customDynaForm = new CustomDynaform();
        $this->getDynaformCustom();
        $this->getDynaformsCustom();
     ...
     * @see \ProcessMaker\BusinessModel\Cases::getCaseVariables()
     */
    public function getDynaformCustom()
    {
        if (!isset($this->fields["CURRENT_DYNAFORM"])) {
            return;
        }
        ...
        $dynaform = $this->customDynaForm->getDynaFormCustom($this->fields["CURRENT_DYNAFORM"]);
        if (empty($dynaform)) {
            $this->translations = null;
            return null;
        }
    ...
    /**
     * Get all dynaforms except this dynaform, related to process, custom method
     * @return array
     * @see PmDynaform->__construct()
     */
    public function getDynaformsCustom()
    {
        if ($this->record === null) {
            return;
        }
        ...
        $result = $this->customDynaForm->getDynaFormsCustom($this->record["PRO_UID"], $this->record["DYN_UID"]);
        $this->records = (array) $result;
        return $this->records;
    }
